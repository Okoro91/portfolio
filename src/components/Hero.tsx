...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="min-h-screen flex items-center justify-center lg:justify-between bg-text-accent w-full pt-20 lg:pt-0 lg:pb-20"
      >
        <style>
          {`
        @keyframes float {
        ...
        <div className="container mx-auto px-4   flex flex-col lg:flex-row items-center ">
          <div className="hero-img relative w-1/2 lg:w-[500px] mb-12 lg:mt-0 lg:mr-10 shadow-xl rounded-xl  animate-float">
            <img
              src={img}
              alt="YourName"
              className="w-full h-64 md:w-80 md:h-80  rounded-x mx-auto object-cover "
            />
          </div>
          <motion.div
